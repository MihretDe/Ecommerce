...
const ServiceComp = ({ title, detail }: prop) => {
  return (
    <div className="flex flex-col items-center">
      <div className="border border-solid bg-[#c1c1c1] w-[80px] h-[80px] rounded-full flex items-center justify-center">
        <div className="border border-solid w-[58px] h-[58px] rounded-full bg-black flex items-center justify-center">
          <svg
            width="41"
            height="40"
            viewBox="0 0 41 40"
