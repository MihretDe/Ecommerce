      ...
      <div className="flex justify-between mx-32 mt-6">
        ...
        <div className="flex gap-5">
          ...
          <div className="flex flex-col">
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-8 mr-32 w-48 bg-[#757076] border-gray-200 rounded-md shadow-lg z-50 bg-opacity-95">
                <p className="px-2  text-sm text-white hover:bg-gray-100 cursor-pointer flex items-center gap-1 py-2">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
