...
const Footer = () => {
  ...
  return (
    <div className="border border-radius bg-black w-full flex justify-between py-12 px-20">
      <div>
        <p className="text-2xl font-bold text-white mb-3">Exclusive</p>
        <p className="text-[20px] font-medium text-white mb-3">Subscribe</p>
        <p className="text-base font-normal text-white mb-3">
          Get 10% off your first order
        </p>
        <div className="border border-solid rounded-[4px] p-2 flex justify-between mb-3">
          <input
            placeholder="Enter Your Email"
            className="text-[#646464] bg-black"
          ></input>
          <svg
            width="22"
            height="20"
      ...
      <div>
        ...
        <p className="text-base font-normal text-white mb-3">My Account</p>
        <p className="text-base font-normal text-white mb-3">
          Login / Register
        </p>
        <p className="text-base font-normal text-white mb-3">Cart </p>
        <p className="text-base font-normal text-white mb-3">Wishlist </p>
        <p className="text-base font-normal text-white mb-3">Shop </p>
      </div>
      <div>
        <p className="text-2xl font-bold text-white mb-3">Quick</p>
        <p className="text-base font-normal text-white mb-3">Privacy Policy</p>
        <p className="text-base font-normal text-white mb-3">Terms Of Use</p>
        <p className="text-base font-normal text-white mb-3">FAQ </p>
        <p className="text-base font-normal text-white mb-3">Contact </p>
      </div>
      <div>
        <p className="text-2xl font-bold text-white mb-3">Download App</p>
        <p className="text-[12px] font-medium text-white mb-3">
          Save $3 with App New User Only
        </p>
        <div className="flex gap-4">
          <div className="bg-white border border-solid p-1 w-22 h-24">
            <QRCode value={qrValue} size={80} />
          </div>
          <div>
            <div className="border border-solid rounded-md flex p-1 items-center justify-center gap-2 mb-3 w-30 h-10">
              <div>
                <img src="assets/google_play.png " className="w-8 h-7"></img>
              </div>
